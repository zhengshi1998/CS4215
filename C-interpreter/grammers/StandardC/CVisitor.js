...
export default class CVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitDeclarationSpecifiers2(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitDirectAbstractDeclarator(ctx) {
	  return this.visitChildren(ctx);
	}
